...
tfidf = pickle.load(open(r"C:\Users\vaish\Downloads\feature.pkl", 'rb'))

#model = pickle.load(open(r"C:\Users\vaish\Downloads\model.pkl", 'rb'))
model = joblib.load(r"C:\Users\vaish\Desktop\stackModel.pkl")

st.title("Spam E-Mail Classifier")

image = Image.open(r"C:\Users\vaish\Downloads\images.jpg")
